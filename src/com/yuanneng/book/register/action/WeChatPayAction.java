...
import com.yuanneng.book.common.utils.TwoDimensionCode;
...
public class WeChatPayAction extends CommonAction {
  ...
  //微信支付商户开通后 微信会提供appid和appsecret和商户号partner
    ...
    public String doMain() {
        ...
        notifyurl = basePath+"register/weChatPayStatusConfirmActon.action"; 
      ...
      //扫码支付
        ...
        String url = getCodeurl(tpWxPay1);
        ...
        userBean.setOrderId(orderId);
        registerService.inserUserTemp(userBean);
        
        
        String imgPath = request.getServletContext().getRealPath("/")+"/images/erweima.png";
    ...
    public static String getCodeurl(WxPayDto tpWxPayDto){
        ...
        new GetWxOrderno();
        String code_url = GetWxOrderno.getCodeUrl(createOrderURL, xml);
