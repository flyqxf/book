...
public class PayPageLinkJianjieAction extends CommonAction {
    ...
    public String doMain() {
        ...
        bean = (PayBean1) session.getAttribute("payCondition_jianjie");

        
        @SuppressWarnings("unchecked")
        CommonPageLinksBean<PayBean1> result = (CommonPageLinksBean<PayBean1>) session.getAttribute("payList_jianjie");
