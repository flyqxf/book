...
public class JianjiePageLinkAction extends CommonAction {
    ...
    public String doMain() {
        ...
        bean = (UserXiaoshouBean) session.getAttribute("jianjieXiaoshouCondition");
        userId = bean.getUserId();
        
        @SuppressWarnings("unchecked")
        CommonPageLinksBean<UserJianjieXiaoshouBean> result = (CommonPageLinksBean<UserJianjieXiaoshouBean>) session.getAttribute("jianjieXiaoshouList");
