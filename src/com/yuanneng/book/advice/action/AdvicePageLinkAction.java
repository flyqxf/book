 ...
 * </pre>
 */
public class AdvicePageLinkAction extends CommonAction {
    ...
    public String doMain() {
        ...
        CommonPageLinksBean<AdviceBean> result1 = (CommonPageLinksBean<AdviceBean>) session.getAttribute(Constant.ADVICE_LIST);
        List<AdviceBean> reportInfoBeans = result1.getResultList();
