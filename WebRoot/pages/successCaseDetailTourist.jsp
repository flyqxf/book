...
<s:include value="%{pageContext.request.contextPath}/pages/common/menuTourist1.jsp" />
    ...
    <s:else>
    <a href="javascript:void(0)" onclick="detailTourist('${preSuccessBeanBean.id}')" style="text-decoration:underline">上一篇</a>
    </s:else>
    &nbsp;|&nbsp;
    ...
    <s:else>
    <a href="javascript:void(0)" onclick="detailTourist('${nextSuccessBeanBean.id}')" style="text-decoration:underline">下一篇</a>
    </s:else>
