...
<s:include value="%{pageContext.request.contextPath}/pages/admin/common/header.jsp" />
    ...
    <div class="itab">
    <ul> 
    <li><a href="#tab2" class="selected">直接销售</a></li> 
    <li><a href="#tab3">间接销售</a></li> 
    </ul>
    </div> 

    <div id="tab2" class="tabson">
    <iframe src="../pay/payZhijieAction.action"  width="100%" height="600" frameborder="no" border="0" marginwidth="0" marginheight="0"  style="border:0;"></iframe>
    
    </div>  
    
    <div id="tab3" class="tabson">
    <iframe src="../pay/payJianjieAction.action"  width="100%" height="600" frameborder="no" border="0" marginwidth="0" marginheight="0"  style="border:0;"></iframe>
