...
var pay1 = function(){
    ...
    var unpaid_qq="0";
    var unpaid_dq="0";
    payInfos = payInfos.replace("[","");
    payInfos = payInfos.replace("]","");
    infos = payInfos.split(",");
/*
    $.each(infos,function(idx,data){
        alert(data.unpaid);
        if(idx == 0) {
            
            unpaid_qqq = data.unpaid;
            
        }else if(idx == 1) {
            unpaid_qq = data.unpaid;
            alert(unpaid_qq);
        }else if(idx ==2) {
            unpaid_dq = data.unpaid;
            alert(unpaid_dq);
        }
    });
*/
...
<table width="539" height="146" border="3">
      <tr>
        <th colspan="5" bgcolor="#FF9933" scope="col">直接销售业绩</th>
      </tr>
      <tr>
        <td bgcolor="#FF6600"><div align="center">项目</div></td>
        <td bgcolor="#FF6600"><div align="center">销售人数</div></td>
        <td bgcolor="#FF6600"><div align="center">奖励金额</div></td>
        <td bgcolor="#FF6600"><div align="center">未支付金额</div></td>
        <td bgcolor="#FF6600"><div align="center">操作</div></td>
      </tr>
      <s:iterator value="%{#session.ZhifuList}"
      ...
      <tr>
        ...
        <td width="68"><input id="ch1" type="checkbox" name="checkbox" value="<s:property value='#res.index+1' />" /></td>
      </tr>
      </s:iterator>
      ...
      <tr>
        <td width="87">前前期</td>
        <td width="82"><strong>${outPayBean.personSum_Summary_qqq}</strong></td>
        <td width="132">${outPayBean.pay_qqq}元</td>
        <td width="132">${outPayBean.unpaid_qqq}元</td>
        <td width="68"><input id="ch1" type="checkbox" name="checkbox" value="1" /></td>
      </tr>
      <tr>
        <td>前期</td>
        ...
        <td><input id="ch2" type="checkbox" name="checkbox2" value="2" /></td>
      </tr>
      <tr>
        <td>当期</td>
        ...
        <td><input id="ch3" type="checkbox" name="checkbox3" value="3" /></td>
      </tr>
      <tr>
...
<p><br />
  ...
  <br />
  <form method="post" id="payForm" action="./payZhijie.action">
