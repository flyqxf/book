...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/advice/adviceDetail.js"></script>
<script type="text/javascript">
link = "${adviceBean.link}"
path="${adviceBean.path}"
</script>
</head>
...
<s:include value="%{pageContext.request.contextPath}/pages/common/menu1.jsp" />
    ...
    <p >
    <s:if test='preAdviceBean == null'>
    上一篇
    </s:if>
    <s:else>
    <a href="javascript:void(0)" onclick="detail('${preAdviceBean.id}')" style="text-decoration:underline">上一篇</a>
    </s:else>
    &nbsp;|&nbsp;
    <s:if test='nextAdviceBean == null'>
    下一篇
    </s:if>
    <s:else>
    <a href="javascript:void(0)" onclick="detail('${nextAdviceBean.id}')" style="text-decoration:underline">下一篇</a>
    </s:else>
    ...
    <div id="title" class="adviceTitle"><s:property value='adviceBean.adviceTitle' /></div>
    <br />
    <div id = "detail" class="adviceDetail"><s:property value='adviceBean.adviceDetail' /></div>
