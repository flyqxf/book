...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/article/articleIframe.js"></script>
<style media="screen">
    *{margin:0;padding:0}
    .select-group{
      margin:10px auto;
...
<body class="sarchbody">
    <div id="resList">
    <form id="formSearch1" method="post"  action="../article/articleDetail.action">
    ...
    <table class="tablelist">
        ...
        <td><a href="javascript:void(0)"  onclick="articleDetail('${id}')" class="tablelink">查看</a>
        &nbsp;&nbsp;&nbsp;
        <a href="javascript:void(0)"  onclick="delArticle('${id}')" class="tablelink"> 删除</a></td>
        </tr> 
        </s:iterator>
    ...
    <gsp:pageLinks totalProperty="totalProperty" indexProperty="indexProperty" rowProperty="rowProperty"
                  submit="true" action="../article/articlePageLinks.action" name="HELP_LIST" />
