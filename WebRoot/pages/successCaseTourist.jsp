...
<div id="m-content">
<s:include value="%{pageContext.request.contextPath}/pages/common/menuTourist1.jsp" />
    ...
    <table class="tablelist">
        ...
        <tr>
        <td onclick="detailTourist('${id}')"><s:property value='#res.index+1' /></td>
        <td onclick="detailTourist('${id}')"><s:property value='title' /></td>
        <td onclick="detailTourist('${id}')"><s:property value='createUser' /></td>
        <td onclick="detailTourist('${id}')"><s:property value='province' /><s:property value='city' /></td>
        <td onclick="detailTourist('${id}')"><s:property value='createTime' /></td>
        </tr>
    ...
    <gsp:pageLinks totalProperty="totalProperty" indexProperty="indexProperty" rowProperty="rowProperty"
                  submit="true" action="../successCase/pageLinksTourist.action" name="SUCCESS_CASE_LIST" />
	</div> 
    </div>
</div>
</div>
