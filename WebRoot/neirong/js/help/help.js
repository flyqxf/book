$(document).ready(function(e) {
    ...
    $("#helpSubmit").off('click').click(helpSubmit);
});
...
var helpSubmit = function() {
    ...
    var url = "../helpJ/helpAdd.action";
    var t = "问题录入";
    
    var id=$("#id").val();
    if(id != null && id!="") {
        url =  "../helpJ/helpEdit.action";
        t = "问题修改";
    }
    parem = {
            "pro" : pro,
...
var addResult = function(data) {
    if (data != undefined && data != "") {
        ...
        // 处理成功情况
        if (status == "success") {
            showInfoMessage(msg, "提示信息", "/help/help.action");
        } else {
...
var detail = function(id) {
    var url = "../help/helpDetail.action";
    // 迁移参数设定
